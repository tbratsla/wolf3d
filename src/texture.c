...
{
	if (!(wolf->texture->wall_text = ft_memalloc(sizeof(SDL_Surface) *\
		TEXTNUM)) || !(wolf->texture->floor_text =\
		ft_memalloc(sizeof(SDL_Surface) * 2)))
	{
		ft_putendl("ERROR: cannot load texture (");
		exit(1);
	}
	wolf->texture->wall_text[0] =\
	load_texture("./texture/glass_light_blue.png");
	wolf->texture->wall_text[1] = load_texture("./texture/brick.png");
	wolf->texture->wall_text[2] =\
	load_texture("./texture/redstone_lamp_on.png");
	wolf->texture->wall_text[3] =\
	load_texture("./texture/crafting_table_front.png");
	...
	wolf->texture->wall_text[11] =\
	load_texture("./texture/leaves_acacia_opaque.png");
	load_textures2(wolf);
}
...
void			load_textures2(t_wolf *wolf)
{
	...
	wolf->texture->wall_text[21] =\
	load_texture("./texture/pumpkin_face_on.png");
	...
	wolf->texture->wall_text[27] =\
	load_texture("./texture/stonebrick_mossy.png");
...
{
	wolf->texture->wall_text[30] =\
	load_texture("./texture/wool_colored_blue.png");
	wolf->texture->wall_text[31] =\
	load_texture("./texture/wool_colored_lime.png");
	wolf->texture->wall_text[32] =\
	load_texture("./texture/wool_colored_purple.png");
	wolf->texture->wall_text[33] =\
	load_texture("./texture/wool_colored_yellow.png");
	wolf->texture->floor_text[0] =\
	load_texture("./texture/wool_colored_blue.png");
